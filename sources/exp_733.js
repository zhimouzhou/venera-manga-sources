...
class Exp733Source extends ComicSource {
    name = "733动漫"
    key = "733_2"
    version = "0.1.0"
    minAppVersion = "1.6.0"
    url = "https://www.733.so"
    status = "experimental"
    ...
    notReady() {
        throw "733动漫 experimental: 当前检测存在 Cloudflare/人机验证，尚未完成搜索、详情、章节、图片解析。"
    }

    search = { load: async () => this.notReady(), optionList: [] }
    explore = [{ title: "733动漫", type: "multiPageComicList", load: async () => this.notReady() }]
    comic = {
