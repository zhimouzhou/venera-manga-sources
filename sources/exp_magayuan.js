...
class ExpMagayuanSource extends ComicSource {
    name = "漫画园漫画"
    key = "source_54"
    version = "0.1.0"
    minAppVersion = "1.6.0"
    url = "https://m.magayuan.com"
    status = "experimental"
    ...
    notReady() {
        throw "漫画园漫画 experimental: 当前检测存在 Cloudflare/人机验证，尚未完成搜索、详情、章节、图片解析。"
    }

    search = { load: async () => this.notReady(), optionList: [] }
    explore = [{ title: "漫画园漫画", type: "multiPageComicList", load: async () => this.notReady() }]
    comic = {
